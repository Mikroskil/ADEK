...
public class baju_adat extends Fragment {
	private int[][] imgPAs = {
				...
				{R.raw.pa_sumbar2},//Sumatra barat
				{R.raw.pa_riau1},
				{R.raw.pa_lampung},
				{R.raw.pa_bengkulu3},
				{R.raw.eg1},//jambi
	...
	private int[][] txtPAs = {
			...
			{R.string.about}, //kalbar
			{R.string.about}, //kalsel
			{R.string.about}, //kalut
			{R.string.about} //kaltim
	};
	private String[] listProv = {
			...
			"DI Yogyakarta","Kalimantan Barat","Kalimantan Selatan","Kalimantan Utara",
